...
import Gpu from "../modules/MGpu.ts";

export default class Cube extends Resource {
  ...
  upload() {
    ...
    const device = Gpu.module.device;
    ...
    device.queue.writeBuffer(positionBuffer, 0, this.positions);
    device.queue.writeBuffer(normalBuffer, 0, this.normals);
  }
}
